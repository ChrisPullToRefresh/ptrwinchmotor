...
import (
	...
	"github.com/ChrisPullToRefresh/ptrwinchmotor/ptrwinchmotormodule"
...
func main() {
	...
	utils.ContextualMain(mainWithArgs, module.NewLoggerFromArgs("ptrwinchmotor"))
}
...
func mainWithArgs(ctx context.Context, args []string, logger logging.Logger) (err error) {
	...
	err = myMod.AddModelFromRegistry(ctx, motor.API, ptrwinchmotormodule.Model)
	if err != nil {
		return err
	}
